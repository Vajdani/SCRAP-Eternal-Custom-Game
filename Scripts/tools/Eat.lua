...
--SE
local berserkRend = { "$CONTENT_DATA/Objects/Rend/prp_berserk.rend" }
local hasteRend = { "$CONTENT_DATA/Objects/Rend/prp_haste.rend" }
local quadRend = { "$CONTENT_DATA/Objects/Rend/prp_quad.rend" }
local allRend = { "$CONTENT_DATA/Objects/Rend/prp_all.rend" }
--SE
...
--SE
sm.tool.preloadRenderables( berserkRend )
sm.tool.preloadRenderables( hasteRend )
sm.tool.preloadRenderables( quadRend )
sm.tool.preloadRenderables( allRend )
--SE
...
local FoodUuidToRenderable =
{
	...
	--SE
	[tostring( prp_berserk )] = berserkRend,
	[tostring( prp_haste )] = hasteRend,
	[tostring( prp_quad )] = quadRend,
	[tostring( prp_all )] = allRend
	--SE
}
