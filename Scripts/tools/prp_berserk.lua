...
Berserk.swingCount = 2
Berserk.mayaFrameDuration = 1.0/30.0
Berserk.freezeDuration = 0.075

Berserk.swings = { "sledgehammer_attack1", "sledgehammer_attack2" }
Berserk.swingFrames = { 4.2 * Berserk.mayaFrameDuration, 4.2 * Berserk.mayaFrameDuration }
Berserk.swingExits = { "sledgehammer_exit1", "sledgehammer_exit2" }

function Berserk.client_onCreate( self )
	self.isLocal = self.tool:isLocal()
	self:init()
end

function Berserk.client_onRefresh( self )
	self:init()
	self:loadAnimations()
end

function Berserk.init( self )
...
function Berserk.loadAnimations( self )
...
function Berserk.client_onUpdate( self, dt )
...
function Berserk.updateFreezeFrame( self, state, dt )
...
function Berserk.server_startEvent( self, params )
...
function Berserk.client_startLocalEvent( self, params )
	self:client_handleEvent( params )
end

function Berserk.client_handleEvent( self, params )
...
--function Berserk.sv_n_toggleTumble( self )
--	local character = self.tool:getOwner().character
--	character:setTumbling( not character:isTumbling() )
--end

function Berserk.client_onEquippedUpdate( self, primaryState, secondaryState )
...
function Berserk.client_onEquip( self, animate )
...
function Berserk.client_onUnequip( self, animate )
...
function Berserk.sv_updateBlocking( self, isBlocking )
